...
@click.option(
    '--input_file',
    type=click.File('r'),
    help='File in which there is the etx you wnat to encrypt/decrypt.'
...
@click.option(
    '--decrypt/--encrypt',
    '-d/-e',
    help='Whether you want to encrypt the inupt text or decrypt it.'
    )
@click.option(
    '--key',
    '-k',
...
def ceasar(input_file, output_file, decrypt, key):
    if input_file:
